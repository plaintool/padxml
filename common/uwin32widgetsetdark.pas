...
function TrackBarWindowProc(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lParam: Windows.LPARAM;
...
class function TWin32WSTrackBarDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
begin
...
class procedure TWin32WSTrackBarDark.DefaultWndHandler(const AWinControl: TWinControl; var AMessage);
var
  NMHdr: PNMHDR;
...
function ScrollBoxWindowProc(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lParam: Windows.LPARAM;
  uISubClass: UINT_PTR; dwRefData: DWORD_PTR): LRESULT; stdcall;
var
  DC: HDC;
  R, W: TRect;
...
class function TWin32WSScrollBoxDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
begin
  Result := inherited CreateHandle(AWinControl, AParams);
...
class procedure TWin32WSPopupMenuDark.Popup(const APopupMenu: TPopupMenu; const X, Y: integer);
begin
...
class function TWin32WSWinControlDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
  P: TCreateParams;
begin
  P := AParams;
...
function FormWndProc2(Window: HWnd; Msg: UInt; WParam: Windows.WParam; LParam: Windows.LParam): LResult; stdcall;
var
  DC: HDC;
  R: TRect;
begin
...
class function TWin32WSCustomFormDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
...
function ListBoxWindowProc2(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lParam: Windows.LPARAM;
  uISubClass: UINT_PTR; dwRefData: DWORD_PTR): LRESULT; stdcall;
var
  PS: TPaintStruct;
begin
...
class function TWin32WSCustomListBoxDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
  P: TCreateParams;
begin
  P := AParams;
...
function CheckListBoxWindowProc2(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lParam: Windows.LPARAM;
  uISubClass: UINT_PTR; dwRefData: DWORD_PTR): LRESULT; stdcall;
var
  PS: TPaintStruct;
begin
...
class function TWin32WSCustomCheckListBoxDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
  P: TCreateParams;
begin
  P := AParams;
...
function CalendarWindowProc2(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lParam: Windows.LPARAM;
  uISubClass: UINT_PTR; dwRefData: DWORD_PTR): LRESULT; stdcall;
begin
  case Msg of
    WM_ERASEBKGND:
...
class function TWin32WSCustomCalendarDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
  P: TCreateParams;
  R: TRect;
begin
...
class function TWin32WSCustomMemoDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
  P: TCreateParams;
begin
  P := AParams;
...
function ComboBoxWindowProc(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lparam: Windows.LPARAM; uISubClass: UINT_PTR;
...
class function TWin32WSCustomComboBoxDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
var
  Info: TComboboxInfo;
begin
  AWinControl.Color := SysColor[COLOR_BTNFACE];
...
class function TWin32WSCustomComboBoxDark.GetDefaultColor(const AControl: TControl; const ADefaultColorType: TDefaultColorType): TColor;
const
...
function StatusBarWndProc(Window: HWND; Msg: UINT; wParam: Windows.WPARAM; lParam: Windows.LPARAM;
  uISubClass: UINT_PTR; dwRefData: DWORD_PTR): LRESULT; stdcall;
var
  DC: HDC;
  X: integer;
...
class function TWin32WSStatusBarDark.CreateHandle(const AWinControl: TWinControl; const AParams: TCreateParams): HWND;
begin
  Result := inherited CreateHandle(AWinControl, AParams);
...
function DrawThemeTextDark(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; pszText: LPCWSTR;
...
begin
  ...
  begin
    if iPartId in [MENU_BARBACKGROUND, MENU_POPUPITEM, MENU_POPUPGUTTER, MENU_POPUPSUBMENU,
      MENU_POPUPSEPARATOR, MENU_POPUPCHECK, MENU_POPUPCHECKBACKGROUND] then
    begin
      LCanvas := TCanvas.Create;
      try
        LCanvas.Handle := hdc;
...
var
  __CreateWindowExW: function(dwExStyle: DWORD; lpClassName: LPCWSTR; lpWindowName: LPCWSTR; dwStyle: DWORD;
  X: longint; Y: longint; nWidth: longint; nHeight: longint; hWndParent: HWND; hMenu: HMENU; hInstance: HINST;
  lpParam: LPVOID): HWND; stdcall;
...
function _CreateWindowExW(dwExStyle: DWORD; lpClassName: LPCWSTR; lpWindowName: LPCWSTR; dwStyle: DWORD;
  X: longint; Y: longint; nWidth: longint; nHeight: longint; hWndParent: HWND; hMenu: HMENU; hInstance: HINST;
  lpParam: LPVOID): HWND; stdcall;
var
...
function TaskDialogIndirectDark(const pTaskConfig: PTASKDIALOGCONFIG; pnButton: PInteger; pnRadioButton: PInteger;
...
function FormWndProc(Window: HWnd; Msg: UInt; WParam: Windows.WParam; LParam: Windows.LParam): LResult; stdcall;
var
  Info: PWin32WindowInfo;
begin
...
var
  ...
  TrampolineDrawThemeText: function(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; pszText: LPCWSTR;
  iCharCount: integer; dwTextFlags, dwTextFlags2: DWORD; const pRect: TRect): HRESULT; stdcall = nil;
  TrampolineDrawThemeBackground: function(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect;
  pClipRect: Pointer): HRESULT; stdcall = nil;

procedure DrawCheckBox(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect; pClipRect: PRECT);
var
  LCanvas: TCanvas;
  AStyle: TTextStyle;
  OffsetX: integer;
...
begin
  ...
  try
    ...
    // Draw checkbox state
    if iStateId in [CBS_MIXEDNORMAL, CBS_MIXEDHOT, CBS_MIXEDPRESSED, CBS_MIXEDDISABLED] then
    begin
      LCanvas.Font.Color := RGBToColor(120, 120, 120);
      LCanvas.TextRect(pRect, OffsetX, 0, MDL_CHECKBOX_GRAYED, AStyle);
    end
    else if iStateId in [CBS_CHECKEDNORMAL, CBS_CHECKEDHOT, CBS_CHECKEDPRESSED, CBS_CHECKEDDISABLED] then
    begin
      LCanvas.Font.Color := RGBToColor(192, 192, 192);
...
procedure DrawRadionButton(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect; pClipRect: PRECT);
var
  LCanvas: TCanvas;
  AStyle: TTextStyle;
begin
  ...
  try
    ...
    if iStateId in [RBS_CHECKEDNORMAL, RBS_CHECKEDHOT, RBS_CHECKEDPRESSED, RBS_CHECKEDDISABLED] then
    begin
      LCanvas.Font.Color := RGBToColor(192, 192, 192);
...
procedure DrawGroupBox(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect; pClipRect: PRECT);
var
  LCanvas: TCanvas;
begin
  LCanvas := TCanvas.Create;
...
procedure DrawButton(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect; pClipRect: PRECT);
begin
  case iPartId of
...
procedure DrawTabControl(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect; pClipRect: PRECT);
var
  ARect: TRect;
  AColor: TColor;
  ALight: TColor;
...
begin
  ...
  try
    ...
    begin
      ...
      if iPartId in [TABP_TABITEMLEFTEDGE, TABP_TABITEMBOTHEDGE, TABP_TOPTABITEMLEFTEDGE,
        TABP_TOPTABITEMBOTHEDGE] then
      begin
        // Draw left border
...
procedure DrawProgressBar(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pRect: TRect; pClipRect: PRECT);
begin
...
function InterceptDrawThemeText(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; pszText: LPCWSTR;
  iCharCount: integer; dwTextFlags, dwTextFlags2: DWORD; const pRect: TRect): HRESULT; stdcall;
var
  OldColor: COLORREF;
  ClassName: string;
...
function DrawThemeEdgeDark(hTheme: HTHEME; hdc: HDC; iPartId, iStateId: integer; const pDestRect: TRect;
